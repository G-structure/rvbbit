...
;; ; ███████ ██   ██  ██████     ██    ██████   ██████   ███ ███  ██   ████     ██   ██  ██████   ██████  ██   ██ ███████ 
  ...
  ;; (ut/pp {:settings config/settings})
    ...
    ;; bootstrap-REST-subscriptions!
    (doseq [kk (keys @db/subscriptions)]
      (db/add-watcher [] :rvbbit-rest wss/send-reaction kk :param-sub)
      (ut/pp ["🔱" :subbing-to-rest-callback-hooks kk])
      ;; (wss/sub-to-value :rvbbit kk)
      )
